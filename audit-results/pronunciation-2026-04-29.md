...
**Pronunciation Dict:** 0o1LBeebsgd55OeNqno8 (v 911wJfN4YWGPhIuW9zvS)  
...
| 8 | Ich bin ein KI-Assistent vom Fachwelt Verlag. | `ki` / `ka i` / `ka-i` | Ich bin ein KI Assistent vom Fachwelt Verlag. | **PASS** | `08_ich_bin_ein_ki_assistent_vom_fachwelt_verlag.mp3` |
| 9 | Vorab-Registrierung. | `vorab` / `registrierung` | ...vor Abregistrierung." | **PASS** | `09_vorab_registrierung.mp3` |
...
| 16 | max punkt mustermann at firma minus beispiel punkt de | `mustermann` / `firma` | Max Punkt Mustermann at Firma minus Beispiel Punkte. | **PASS** | `16_max_punkt_mustermann_at_firma_minus_beispiel_punkt_de.mp3` |
